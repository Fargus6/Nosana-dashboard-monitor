...
**🖥️ Web App (Desktop & Mobile):** https://nosanamonitor.preview.emergentagent.com
...
- **📱 Telegram Bot Integration**: Enhanced notifications with payment tracking
...
- **🎯 Customizable Events**: Choose which events trigger notifications
  ...
  - Job started
  - **Job completed with duration & actual payment** (from Nosana dashboard)
